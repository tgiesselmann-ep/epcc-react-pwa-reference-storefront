...
export const PcmProduct: React.FC = () => {
        ...
        <div className="product__maincontainer">
          <div className="product__imgcontainer">
            {productImageHrefs.length > 0 && (
              <>
                <img className="product__img" src={productImageHrefs?.[currentImageIndex]} alt={product.attributes.name} /*style={{ backgroundColor: productBackground }}*/ />
                {isPrevImageVisible && (
          ...
          <div className="product__details">
            ...
            <div className="product__sku">
              {child ? child.sku : product.attributes.sku}
            </div>
            ...
            <div className="product__description">
              {child ? child.description : product.attributes.description}
            </div>
            <div className="product__socialshare">
              <SocialShare name={child ? child.name : product.attributes.name} description={child ? child.description : product.attributes.description} imageHref={productImageHrefs?.[0]} />
            </div>
          </div>
        </div>
      ) : (
